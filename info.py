...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL','-1002334593781'))
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','PREMIUM_MOVIES_WEB') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','MOVIESPRIMEHUB1') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','MOVIESPRIMEHUB1') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','MOVIESPRIMEHUB_UPDATES')  # WITHOUT @ [  add only handle - don't add full url  ] 
