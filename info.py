...
API_ID = int(environ['29876662'])
API_HASH = environ['44d6824fffb5f8af133b91935de2dcaa']
BOT_TOKEN = environ['7573110232:AAHNtR-79tx0tcVzJHacPyqjvVYchWOgYS8']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1002376260912').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://chamiudith:<chamiudith>@chamika.inv4i.mongodb.net/?retryWrites=true&w=majority&appName=Chamika")
DATABASE_NAME = environ.get('DATABASE_NAME', "Chamika")
